...
# ---------------------------------------------------------
# SANITIZE FLIGHT FOR JSON SERIALIZATION
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# DFS (original 'find_routes') — keep for compatibility (enumerate all paths up to max_stops)
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# MULTI-CRITERIA DIJKSTRA - Optimizes price, time, and distance simultaneously
# ---------------------------------------------------------
